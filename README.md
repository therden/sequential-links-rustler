...
Options
-------
__Sequential Links Rustler__ has several options for re-configuring aspects of its operation.  

To access them, click the _Show Options_ button.  (The button text will change to _Hide Options_.)
...
- __Choose whether to hide or display links to inaccessible image files__
  ...
  By default, broken links are displayed; but if you want to see links only for images that load successfully, check "Hide broken image links"
...
- __Delete HTML file on Exit__
    ...
    By default, __Sequential Links Rustler__ will delete the last file it generated when it exits.  If you prefer to retain the file, uncheck
