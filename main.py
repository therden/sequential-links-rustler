...
def get_HTML_file(URL_mask, targetfile=None, hide_missing=False):
    ...
    credit = "<br>This page was generated by <a href='https://github.com/therden/sequential-links-rustler'><i>Sequential Links Rustler</i></a>"
    if hide_missing:
        javascript = """
        <script>    <! This script will display all imgs that load succesfully.>
            (function() {
        ...
        """
        javascript = textwrap.dedent(javascript)
    else:
        javascript = ""
    top = f"<HTML>\n<HEAD>\n{style}\n</HEAD>\n<BODY>\n"
    body = ""
