...
def get_HTML_file(URL_mask, targetfile=None):
    ...
    footer = "Generated by LinksRustler"
...
def test_URL_generation_from_masks():
    ...
    test_masks = [
        ...
        "http:///www.example.com/gallery/pic{4-0;-1}",
        "http:///www.example.com/gallery/pic{1-5;2}",
        # "http:///www.example.com/gallery/pic{1:3}",
        # "http:///www.example.com/gallery/pic1800noMask",
        "http:///www.example.com/gallery/pic{5-0;-2}",
        "http:///www.example.com/gallery/pic{001-004}",
        "http:///www.example.com/gallery/pic{005-000;-2}",
        "http:///www.example.com/gallery{10-14;2}/pic{1-3}",
        "http:///www.example.com/gallery{10-14;2}/set{1-3}/pic{003-001;-1}",
    ]
